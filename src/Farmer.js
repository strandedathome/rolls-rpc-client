...
var defaultPort = (rollsConfig === null || rollsConfig === void 0 ? void 0 : rollsConfig.farmer.rpc_port) || 6540;
...
var Farmer = /** @class */ (function (_super) {
    ...
    Farmer.prototype.getSignagePoint = function (signagePointHash) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("get_signage_point", {
                        sp_hash: signagePointHash
                    })];
            });
        });
    };
    Farmer.prototype.getSignagePoints = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("get_signage_points", {})];
            });
        });
    };
    Farmer.prototype.getRewardTarget = function (searchForPrivateKey) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("get_reward_targets", {
                        search_for_private_key: searchForPrivateKey
                    })];
            });
        });
    };
    Farmer.prototype.setRewardTarget = function (farmerTarget, poolTarget) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("set_reward_targets", {
    ...
    Farmer.prototype.getPoolState = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("get_pool_state", {})];
            });
        });
    };
    Farmer.prototype.setPayoutInstructions = function (launcher_id, payout_instructions) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("set_payout_instructions", {
    ...
    Farmer.prototype.getPoolLoginLink = function (launcher_id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("get_pool_login_link", {
                        launcher_id: launcher_id
                    })];
            });
        });
