...
var defaultPort = (rollsConfig === null || rollsConfig === void 0 ? void 0 : rollsConfig.full_node.rpc_port) || 9877;
...
var FullNode = /** @class */ (function (_super) {
    ...
    FullNode.prototype.getBlockchainState = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("get_blockchain_state", {})];
            });
        });
    };
    FullNode.prototype.getNetworkSpace = function (newerBlockHeaderHash, olderBlockHeaderHash) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("get_network_space", {
    ...
    FullNode.prototype.getBlocks = function (start, end, excludeHeaderHash) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("get_blocks", {
                        start: start,
                        end: end,
    ...
    FullNode.prototype.getBlock = function (headerHash) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("get_block", {
                        header_hash: headerHash
                    })];
            });
        });
    };
    FullNode.prototype.getBlockRecordByHeight = function (height) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("get_block_record_by_height", {
                        height: height
                    })];
            });
        });
    };
    FullNode.prototype.getBlockRecord = function (hash) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("get_block_record", {
                        header_hash: hash
                    })];
            });
        });
    };
    FullNode.prototype.getUnfinishedBlockHeaders = function (height) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("get_unfinished_block_headers", {
                        height: height
                    })];
            });
        });
    };
    FullNode.prototype.getUnspentCoins = function (puzzleHash, startHeight, endHeight) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("get_coin_records_by_puzzle_hash", {
    ...
    FullNode.prototype.getCoinRecordByName = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("get_coin_record_by_name", {
                        name: name
                    })];
            });
        });
    };
    FullNode.prototype.getAdditionsAndRemovals = function (hash) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("get_additions_and_removals", {
                        header_hash: hash
                    })];
            });
        });
    };
    FullNode.prototype.getNetworkInfo = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("get_network_info", {})];
            });
        });
    };
    /* https://github.com/CMEONE/chia-utils */
    FullNode.prototype.addressToPuzzleHash = function (address) {
        return (0, chia_utils_1.address_to_puzzle_hash)(address);
    };
    FullNode.prototype.puzzleHashToAddress = function (puzzleHash) {
        return (0, chia_utils_1.puzzle_hash_to_address)(puzzleHash);
    };
    FullNode.prototype.getCoinInfo = function (parentCoinInfo, puzzleHash, amount) {
