...
var defaultPort = (rollsConfig === null || rollsConfig === void 0 ? void 0 : rollsConfig.harvester.rpc_port) || 5433;
...
var Harvester = /** @class */ (function (_super) {
    ...
    Harvester.prototype.getPlots = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("get_plots", {})];
            });
        });
    };
    Harvester.prototype.refreshPlots = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("refresh_plots", {})];
            });
        });
    };
    Harvester.prototype.deletePlot = function (fileName) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("delete_plot", {
                        filename: fileName
                    })];
            });
        });
    };
    Harvester.prototype.addPlotDirectory = function (dirName) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("add_plot_directory", {
                        dirname: dirName
                    })];
            });
        });
    };
    Harvester.prototype.getPlotDirectories = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("get_plot_directories", {})];
            });
        });
    };
    Harvester.prototype.removePlotDirectory = function (dirName) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("remove_plot_directory", {
                        dirname: dirName
                    })];
            });
        });
