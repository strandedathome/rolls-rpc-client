...
var SharedCalls = /** @class */ (function (_super) {
    __extends(SharedCalls, _super);
    function SharedCalls(options) {
    ...
    SharedCalls.prototype.getConnections = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("get_connections", {})];
            });
        });
    };
    SharedCalls.prototype.openConnection = function (host, port) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("open_connection", {
                        host: host,
                        port: port
                    })];
            });
    ...
    SharedCalls.prototype.closeConnection = function (nodeId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("close_connection", {
                        node_id: nodeId
                    })];
            });
        });
    };
    SharedCalls.prototype.stopNode = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("stop_node", {})];
            });
        });
    };
    return SharedCalls;
